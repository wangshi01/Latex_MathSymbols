...
\topmargin -80pt
\textwidth=700pt
\oddsidemargin=-160pt \evensidemargin\oddsidemargin
\textheight 800pt
...
%\X\alpha        &\X\theta       &\X o           &\X\tau         &\X\pi\\ \hline
%\X\beta         &\X\vartheta    &\X\pi          &\X\upsilon     &\X\pi\\
%\X\gamma        &\X\gamma       &\X\varpi       &\X\phi         &\X\pi\\
%\X\delta        &\X\kappa       &\X\rho         &\X\varphi      &\X\pi\\
%\X\epsilon      &\X\lambda      &\X\varrho      &\X\chi         &\X\pi\\
%\X\varepsilon   &\X\mu          &\X\sigma       &\X\psi         &\X\pi\\
%\X\zeta         &\X\nu          &\X\varsigma    &\X\omega       &\X\pi\\
%\X\eta          &\X\xi          &&              &&              &\X\pi    \\ \hline
%                                                                \\
...
% \X\pm           &\X\cap         &\X\diamond             &\X\oplus     &\X\oplus\\
% \X\mp           &\X\cup         &\X\bigtriangleup       &\X\ominus    &\X\oplus\\
% \X\times        &\X\uplus       &\X\bigtriangledown     &\X\otimes    &\X\oplus\\
% \X\div          &\X\sqcap       &\X\triangleleft        &\X\oslash    &\X\oplus\\
% \X\ast          &\X\sqcup       &\X\triangleright       &\X\odot      &\X\oplus\\
% \X\star         &\X\vee         &\X\lhd$^b$             &\X\bigcirc   &\X\oplus\\
% \X\circ         &\X\wedge       &\X\rhd$^b$             &\X\dagger    &\X\oplus\\
% \X\bullet       &\X\setminus    &\X\unlhd$^b$           &\X\ddagger   &\X\oplus\\
% \X\cdot         &\X\wr          &\X\unrhd$^b$           &\X\amalg     &\X\oplus\\
% \X+             &\X-
\end{tabular}
